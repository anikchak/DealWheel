...
public class SendMail {
	...
	public static void sendEmailNotification(String actionCode,String emailbody,String subject,String uEmail) {
			  ...
			  String FROM = "admin@dealwheel.in";   // Replace with your "From" address. This address must be verified.
			    ...
			    // STARTTLS to encrypt the connection.
			     int PORT = 25;
			        ...
			        try
			        {
			            System.out.println("SendMail : Attempting to send an email through the Amazon SES SMTP interface...");
