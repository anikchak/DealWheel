...
function validateData(){
	...
	if ($("#vehicleManufacturer").val() == 'defaultMake' || $("#vehicleManufacturer").val() == null) {
		$("#vehicleManufacturer").css("border-color", "red");
		$('#vehMakeMandateAdd').show();
		emptyField = 'Y';
	}
	if ($("#vehicleName").val() == 'defaultName' || $("#vehicleName").val() == null) {
	...
	if ($("#yearOfManufacture").val() == '' || $("#yearOfManufacture").val() == null) {
	...
	if ($("#securityDeposit").val() == '' || $("#securityDeposit").val() == null) {
	...
	if ($("#cityAdd").val() == '' || $("#cityAdd").val() == null) {
...
$(document).ready(function(){
	...
	function loadVehicleNames() {
		...
		if(vehMake == "defaultMake"){
			$('#vehicleName').append($('<option></option>').val("defaultName").html("Select Vehicle"));
			return;
		}else if(vehMake == "vehMakeOther"){
			$('#vehicleName').append($('<option></option>').val("vehNameOther").html("Other"));
			return;
		}
		$.ajax({
