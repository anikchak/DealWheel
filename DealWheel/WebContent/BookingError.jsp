...
<% 
	...
	<div id="wrap" style="min-height:85%;" >
		...
		<div class="container">
			<span style="color:#687074;text-transform: uppercase;font-size: 12px;"><span style="font-size: 14px;font-weight:bold;color:rgba(217, 83, 79, 1);">Opps..!! </span>Our system did not respond appropriately. We apologize for the inconvenience caused. We are working on fixing the issue.</span> <br>
			<br>
			<a href="${pageContext.request.contextPath}/LandingPage.jsp" style="color:#687074;font-size: 12px;text-transform: uppercase;">Click here to <span style="font-size: 14px;font-weight:bold;color:rgba(217, 83, 79, 1);">re-book</span></a>
  		</div>
	</div>
	<!--/wrap-->
